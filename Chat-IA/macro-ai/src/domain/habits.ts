...
export function buildHabits(user: UserProfile): string[] {
    ...
    const habits: string[] = ["Hidratarse 35–40 ml/kg"];
    ...
    if (profile.cardioRatio > 0.7) {
        ...
        if (user.level === "advanced" || user.level === "elite") habits.push("Suplementación con Electrolitos en entrenos largos");
    }
